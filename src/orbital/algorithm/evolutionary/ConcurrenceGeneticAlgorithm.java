 ...
 */
public
class ConcurrenceGeneticAlgorithm extends IncrementalGeneticAlgorithm {
	/**
 ...
 * je zwei werden verglichen, je zwei Gewinner werden wieder
 * miteinander verglichen. Die Verlierer einer Stufe werden alle gleich eingeschätzt.
 * O(n-1)
 */
 ...
 * jeder gegen jeden: jeder wird mit jedem verglichen
 * O(n/2*(n-1))
 * Einfügen: neuen mit jedem vergleichen und für alle alten die fitness updaten
