 ...
 * will reproduce with {@link Genome#crossover(Gene[],int,double) Genome.crossover} to generate
 ...
 */
public
class Population implements Serializable /*//TODO: extends DelegateList<Genome> sometime, but this is sorted! */ {
	...
	Population newInstance(int capacity) {
		try {
    		...
    		//XXX: instantiated twice for Population type, now, could optimize
	...
	public Object clone() {
		...
		// direct copy to members without merge is stable and will not reorder equal fitnesses
