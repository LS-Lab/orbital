 ...
 * <p>
 * R<sup>n&times;m</sup> = { M=<big>(</big>m<sub>i,j</sub><big>)</big> &brvbar; m<sub>i,j</sub>&isin;R} where
 * <table>
 ...
 */
public
interface Matrix/*<R implements Arithmetic>*/ extends Arithmetic {
	// object-methods
	 ...
	 * <p>
	 * For M<sub>i,j</sub>, bindFirst(c).</p>
	 * @return a vector view of the specified column in this matrix.
	 * @see Functionals#bindFirst(orbital.logic.functor.BinaryFunction, Object)
	 */
	 ...
	 * The returned vector is backed by this matrix, so changes in the returned vector are reflected in this matrix, and vice-versa.
	 * <p>
	 * For M<sub>i,j</sub> bindSecond(r).</p>
	 * @return a vector view of the specified row in this matrix.
	 * @todo document and specify whether the return-value is a clone or a reference to the row vector, etc.
	 * @see Functionals#bindSecond(orbital.logic.functor.BinaryFunction, Object)
	 */
	 ...
	 * </p>
	 * @pre i1<=i2 && j1<=j2 && valid(i1, j1) && valid(i2, j2)
	 ...
	 * If A is n&times;m and
	 * B is m&times;l the resulting Matrix
	 * A&middot;B is n&times;l.
	 ...
	 * If Matrix A is n&times;m and
	 * row vector v is sized m,
	 * the resulting row vector A&middot;v is sized n.
	 * @return the n-dimensional row vector A&middot;v.
